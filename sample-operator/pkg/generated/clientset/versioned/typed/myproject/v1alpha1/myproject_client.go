...
type MyprojectV1alpha1Client struct {
	restClient rest.Interface
}
...
func NewForConfig(c *rest.Config) (*MyprojectV1alpha1Client, error) {
	config := *c
	...
	return &MyprojectV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new MyprojectV1alpha1Client for the given config and
// panics if there is an error in the config.
func NewForConfigOrDie(c *rest.Config) *MyprojectV1alpha1Client {
...
// New creates a new MyprojectV1alpha1Client for the given RESTClient.
func New(c rest.Interface) *MyprojectV1alpha1Client {
	return &MyprojectV1alpha1Client{c}
}
...
func (c *MyprojectV1alpha1Client) RESTClient() rest.Interface {
	if c == nil {
		return nil
	}
	return c.restClient
